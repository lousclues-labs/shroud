...
VPN Shroud is dual-licensed. By submitting a pull request, you agree to the terms in [CONTRIBUTOR-LICENSE.md](licenses/CONTRIBUTOR-LICENSE.md). The short version: you keep your copyright, you license your contribution under GPL-3.0, and you grant Louis Nelson Jr. (the project maintainer and sole copyright holder) permission to include it in the commercial license too. Your code always stays open source.
...
| **Leave No Trace** | If VPN Shroud stops, the system should be clean. |
