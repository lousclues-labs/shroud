...
The following are the standard terms for commercial licenses. Specific terms (including pricing, scope, and support) are negotiated per customer.

### 1. Grant of License

Subject to the terms of this agreement and payment of applicable fees, the Licensor grants the Licensee a:

- **Non-exclusive** — The Licensor retains the right to license the software to others.
- **Worldwide** — Valid in all jurisdictions.
- **Perpetual** (unless terminated) — For the version(s) licensed, the license does not expire.
- **Non-transferable** (unless agreed otherwise) — The license is granted to the named Licensee.
...
Contact the Licensor for a quote. See "Contact" below.

### 4. Support and Maintenance

The Commercial License does **not** include support or maintenance unless separately agreed. Support agreements may be negotiated as an add-on and will be documented separately.

The open-source community resources (issue tracker, documentation) remain available to all users, regardless of license type.
...
**(c)** ANY THIRD-PARTY CONDUCT OR CONTENT IN CONNECTION WITH THE SOFTWARE.

THE LICENSOR'S TOTAL LIABILITY SHALL NOT EXCEED THE AMOUNT PAID BY THE LICENSEE FOR THE COMMERCIAL LICENSE IN THE TWELVE (12) MONTHS PRECEDING THE CLAIM.
...
To inquire about commercial licensing, discuss terms, or request a quote:

| Channel | Contact |
|---------|---------|
| **GitHub** | [@loujr](https://github.com/loujr) — Open an issue or send a message |
| **Website** | [lousclues.com](https://lousclues.com) |
| **Email** | See GitHub profile for current contact information |

Please include:
- Your organization name
- Intended use case (embedding, redistribution, SaaS, etc.)
- Estimated distribution volume
- Any specific terms or requirements
...
*This commercial license template is provided as a framework for negotiation. Specific commercial license agreements will be documented in a separate agreement or order form signed by both parties. This document is not a substitute for legal advice.*
