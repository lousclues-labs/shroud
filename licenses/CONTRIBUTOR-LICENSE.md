...
VPN Shroud is dual-licensed under the [GNU General Public License v3.0 or later](../LICENSE) (for open-source use) and a [Commercial License](LICENSE-COMMERCIAL.md) (for proprietary use). For dual-licensing to work, the project maintainer needs the legal right to distribute all contributions under both licenses.

This Contributor License Agreement ("CLA") establishes the terms under which you ("Contributor") grant rights to **Louis Nelson Jr.** ("Maintainer"), the sole copyright holder and maintainer of the VPN Shroud project.
...
2. **You give the project a broad license.** You allow the Maintainer to use your contribution under both the GPL and the commercial license (and any future license the project may adopt).
3. **Your code stays open source.** Your contribution will always be available under the GPL in the open-source version. The commercial license doesn't remove it from the open-source release.
...
- Under any license, including but not limited to the GPL-3.0-or-later, the project's Commercial License, and any successor or additional licenses the project may adopt.
...
- Change the open-source license of the Project (e.g., from GPL-3.0 to a different open-source license), provided your Contribution remains available under an OSI-approved open-source license.
- Offer the Project under additional or different commercial terms.
...
By submitting a Contribution to the VPN Shroud project (via pull request, patch, or any other submission method), you signify your agreement to the terms of this CLA.
...
> I have read and agree to the VPN Shroud Contributor License Agreement (CONTRIBUTOR-LICENSE.md).
